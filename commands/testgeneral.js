...
exports.permissions = (client) => {
    return perms = {
        ...
        role: client.perms.trusted     //Last word specifies permission level needed to use this command
    }
}
...
exports.run = (client, message, args) => {
    ...
    message.channel.send('This should work in any channel the bot can see');
};
